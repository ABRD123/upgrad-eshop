...
import { Container, ToggleButtonGroup, ToggleButton, Typography, Select, MenuItem } from '@mui/material';
...
const Products = () => {
    ...
    return ( <>
        ...
        <Container sx={{display: 'flex', justifyContent: 'center', marginTop: 2}} maxWidth='xl'>
